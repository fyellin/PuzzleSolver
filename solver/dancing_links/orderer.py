...
class _OrdererLtLe[T: Hashable]:
    @overload
    def __init__(self: _OrdererLtLe[int], prefix: str, count: int, is_lt: bool) -> None: ...
    @overload
...
class OrdererLessEqual[T: Hashable](_OrdererLtLe):
    @overload
...
class OrdererLessThan[T: Hashable](_OrdererLtLe):
    @overload
