...
def main():
    ...
    ciphertext = """
    sudras missal poopoo pipi corral pedi nesses arid dune nutter dogged twirp, sliest
    rain pita blatt nile petal arena serran latest donets
     siccan crinal brutal dorrit willet roro dene soled palest mossad seamed pistole
     siped tern geist aidan trant laiked tablas
    
    """
    corpus = "../misc/words2.txt"

    solver = SubSolver(ciphertext, corpus)
    solver.solve()
    solver.print_report()
