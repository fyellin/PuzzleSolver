...
def parse_grid(path):
    ...
    for i, digit in enumerate(digits):
        image = cv2.bitwise_not(digit, digit)
        num = pytesseract.image_to_string(image, config='--psm 6 --oem 1 -c tessedit_char_whitelist=0123456789')
        nums.append(num or '.')
        print(i)
    print(''.join(nums))
...
def main():
    parse_grid('/users/fy/desktop/Sudoku.png')
